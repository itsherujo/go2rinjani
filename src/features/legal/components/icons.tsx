...
export const PrevIcon = ({ className = "size-3" }: { className?: string }) => (
...
export const NextIcon = ({ className = "size-3" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ExpandIcon = ({ className = "size-5" }: { className?: string }) => (
...
export const ReadingModeIcon = ({ className = "size-6", readingMode }: { className?: string; readingMode: boolean }) => (
...
export const TocIcon = ({ className = "size-6" }: { className?: string }) => (
...
export const SettingsIcon = ({ className = "size-5" }: { className?: string }) => (
